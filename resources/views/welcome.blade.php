...
<head>
  ...
  <title>Alumni Akamademi Manajemen Informatika & Komputer Global Kendari</title>
  <meta content="" name="descriptison">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <!-- <link href="assets/images/umj.png" rel="icon">
  <link href="assets/images/umj.png" rel="apple-touch-icon"> -->

  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">

  <!-- Vendor CSS Files -->
  <link href="assets/frontend/lp/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="assets/frontend/lp/vendor/icofont/icofont.min.css" rel="stylesheet">
  <link href="assets/frontend/lp/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="assets/frontend/lp/vendor/remixicon/remixicon.css" rel="stylesheet">
...
<body>
        ...
        <div class="carousel-item" style="background-image: url('assets/frontend/lp/img/slide/sl2.jpg')">
          <div class="carousel-container">
            <div class="container">
              ...
              <p class="animated fadeInUp">Aplikasi Pendataan alumni</p>
            </div>
          </div>
        </div>

        <!-- Slide 3 
        <div class="carousel-item" style="background-image: url('assets/frontend/lp/img/slide/sl3.jpg')">
          <div class="carousel-container">
            <div class="container">
      ...
      <div class="container-fluid">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-xl-11 col-lg-12 icon-boxes d-flex flex-column align-items-stretch justify-content-center py-5 px-lg-5 text-justify">
            <h2 class="text-center">Tracer Study AMIK Global Kendari</h2>
            <hr>
            <p> Seluruh alumni AMIK Global Kendari diharapkan mendaftar dan melengkapi data tracer study. Angket tracer study dapat diakses setelah alumni login ke sistem.</p>
  ...
  <footer id="footer">
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Tracer Study AMIK Global Kendari</span></strong>. All Rights Reserved 2023      </div>
      <div class="credits">
  ...
  <!-- Vendor JS Files -->
  <script src="assets/frontend/lp/vendor/jquery/jquery.min.js"></script>
  <script src="assets/frontend/lp/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="assets/frontend/lp/vendor/jquery.easing/jquery.easing.min.js"></script>
  <script src="assets/frontend/lp/vendor/php-email-form/validate.js"></script>
  <script src="assets/frontend/lp/vendor/venobox/venobox.min.js"></script>
  <script src="assets/frontend/lp/vendor/waypoints/jquery.waypoints.min.js"></script>
  <script src="assets/frontend/lp/vendor/counterup/counterup.min.js"></script>
  <script src="assets/frontend/lp/vendor/isotope-layout/isotope.pkgd.min.js"></script>
  <script src="assets/frontend/lp/vendor/owl.carousel/owl.carousel.min.js"></script>
