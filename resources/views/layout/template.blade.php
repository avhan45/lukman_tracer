    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Tracer <sup>Alumni</sup></div>
            </a>
            ...
            <li class="nav-item {{ (request()->segment(1) == "alumni") ? 'active' : '' }}">
                <a href="{{ url('alumni') }}" class="nav-link collapse">
            ...
            <li class="nav-item {{ (request()->segment(1) == "user") ? 'active' : '' }}">
                <a href="{{ url('user') }}" class="nav-link collapse">
                    <i class="fas fa-fw fa-user"></i>
                    <span>User</span>
                </a>
            </li>
                      ...
                      <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="{{ url('profile/kusioner/') }}">
                                    <div>
